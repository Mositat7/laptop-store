...
<head>
  <meta charset="utf-8">
    ...
    <title>Superieur Admin - Dashboard  User list</title>
      ...
      <ul class="sidebar-menu" data-widget="tree">
		...
		<li class="treeview">
          ...
          <ul class="treeview-menu">
            ...
            <li><a href="ecommerce_cart.html"><i class="mdi mdi-toggle-switch-off"></i>Products Cart</a></li>
            <li><a href="ecommerce_products_edit.html"><i class="mdi mdi-toggle-switch-off"></i>Products Edit</a></li>
			...
			<div class="scrollable" style="height: 100%;">
				<div class="left-content-area">
					...
					<div class="box no-shadow">
						<div class="box-body">
						  <a class="btn btn-outline btn-success btn-block text-left mb-5" href="javascript:void(0)">Online <span class="pull-right">103</span></a>
						  <a class="btn btn-outline btn-danger btn-block text-left mb-5" href="javascript:void(0)">Offline <span class="pull-right">19</span></a>
						  <a class="btn btn-outline btn-info btn-block text-left mb-5" href="javascript:void(0)">Available <span class="pull-right">623</span></a>
						  <a class="btn btn-outline btn-primary btn-block text-left mb-5" href="javascript:void(0)">Private <span class="pull-right">53</span></a>
						  <a class="btn btn-warning btn-block btn-lg text-left mt-10" href="javascript:void(0)">All Contacts <span class="pull-right">123</span></a>
						  <a href="javascript:void(0)" data-toggle="modal" data-target="#myModal" class="btn btn-success btn-block btn-lg mt-10">+ Add New Contact</a>
					  </div>
					</div>
				  <!-- /. box -->
