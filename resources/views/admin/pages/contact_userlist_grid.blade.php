            ...
            <div class="box">
			  ...
			  <div class="box-body">
				  <div class="text-center">
					...
					<h3 class="my-5"><a href="#">Tristan</a></h3>
					<h6 class="user-info mt-0 mb-5 text-lighter">Designer</h6>
					...
					<p class="text-uppercase text-fade">125 Ipsum Lorem Ave, Suite 458 New York, USA 154875 </p>
				  </div>
			  </div>
            </div>
          </div>
            ...
            <div class="box">
			  ...
			  <div class="box-body">
				  <div class="text-center">
					...
					<h3 class="my-5"><a href="#">Sophia</a></h3>
					<h6 class="user-info mt-0 mb-5 text-lighter">Full Stack Developer</h6>
					  <div class="gap-items user-social font-size-16 p-15">
						<a class="text-facebook" href="#"><i class="fa fa-facebook"></i></a>
						<a class="text-instagram" href="#"><i class="fa fa-instagram"></i></a>
						<a class="text-google" href="#"><i class="fa fa-google"></i></a>
            ...
            <div class="box">
			  ...
			  <div class="box-body">
				  <div class="text-center">
					...
					<h3 class="my-5"><a href="#">Jacob</a></h3>
					<h6 class="user-info mt-0 mb-5 text-lighter">Support Agent</h6>
					  <div class="gap-items user-social font-size-16 p-15">
						<a class="text-facebook" href="#"><i class="fa fa-facebook"></i></a>
						<a class="text-instagram" href="#"><i class="fa fa-instagram"></i></a>
						<a class="text-google" href="#"><i class="fa fa-google"></i></a>
            ...
            <div class="box">
			  ...
			  <div class="box-body">
				  <div class="text-center">
					...
					<h3 class="my-5"><a href="#">Isabella</a></h3>
					<h6 class="user-info mt-0 mb-5 text-lighter">Designer</h6>
					  <div class="gap-items user-social font-size-16 p-15">
						<a class="text-facebook" href="#"><i class="fa fa-facebook"></i></a>
						<a class="text-instagram" href="#"><i class="fa fa-instagram"></i></a>
            ...
            <div class="box">
			  ...
			  <div class="box-body">
				  <div class="text-center">
					...
					<h3 class="my-5"><a href="#">Emma</a></h3>
					<h6 class="user-info mt-0 mb-5 text-lighter">Support Agent</h6>
					  <div class="gap-items user-social font-size-16 p-15">
						<a class="text-facebook" href="#"><i class="fa fa-facebook"></i></a>
						<a class="text-instagram" href="#"><i class="fa fa-instagram"></i></a>
            ...
            <div class="box">
			  ...
			  <div class="box-body">
				  <div class="text-center">
					...
					<h3 class="my-5"><a href="#">William</a></h3>
					<h6 class="user-info mt-0 mb-5 text-lighter">Marketing Department</h6>
					  <div class="gap-items user-social font-size-16 p-15">
						<a class="text-facebook" href="#"><i class="fa fa-facebook"></i></a>
						<a class="text-instagram" href="#"><i class="fa fa-instagram"></i></a>
						<a class="text-google" href="#"><i class="fa fa-google"></i></a>
            ...
            <div class="box">
			  ...
			  <div class="box-body">
				  <div class="text-center">
					...
					<h3 class="my-5"><a href="#">Michael</a></h3>
					<h6 class="user-info mt-0 mb-5 text-lighter">Designer</h6>
					  <div class="gap-items user-social font-size-16 p-15">
						<a class="text-facebook" href="#"><i class="fa fa-facebook"></i></a>
						<a class="text-instagram" href="#"><i class="fa fa-instagram"></i></a>
