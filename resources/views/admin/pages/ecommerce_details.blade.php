...
<head>
  <meta charset="utf-8">
	...
	<!-- Bootstrap extend-->
	<link rel="stylesheet" href="{{asset('ss/bootstrap-extend.css')}}">
                          ...
                          <div class="row">
                              ...
                              <div class="col-md-4 col-sm-6">
                                  <div class="box box-body b-1 text-center no-shadow">
                                      <img src="{{ asset($product->main_image) }}" id="product-image" class="img-fluid" alt="{{ $product->name }}" />
                                  </div>

                                  {{-- تصاویر گالری --}}
                                  <div class="pro-photos mt-3">
                              ...
                              <div class="col-md-8 col-sm-6">
                                  ...
                                  <h1 class="pro-price mb-0 mt-20">
                                      ...
                                      @if($product->discount_price)
                                        ...
                                        {{ round((1 - $product->price / $product->discount_price) * 100) }}% off
                                    </span>
                                      @endif
                                  </h1>
                                  ...
                                  @if($product->description)
                                      <div class="mt-3 text-zinc-700 fw-bold">ویژگی‌های محصول:</div>
                                          ...
                                          @foreach([
                                              ...
                                              @if($product->$field)
                                                  <div class="feature-box">
                                                      ...
                                                      <div class="feature-value">{{ $product->$field }}</div>
                                                  </div>
                                              @endif
                                          @endforeach
                                      </div>
                                  ...
                                  {{-- رنگ‌ها --}}
                                  <h6 class="mt-20">Available Colors</h6>
                                  <div class="d-flex flex-wrap">
                                      @if($product->colors && $product->colors->count() > 0)
                                          ...
                                          @endforeach
                                      @else
                                          <span class="text-muted">No colors listed</span>
                                      @endif
                                  </div>

                                  {{-- سایزها --}}
                                  <h6 class="mt-20">Available Sizes</h6>
                                  <p class="mb-0 d-flex flex-wrap">
                                      @if($product->sizes && $product->sizes->count() > 0)
                                          @foreach($product->sizes as $size)
                                              <span class="badge badge-lg badge-secondary size-badge">
                                            {{ $size->name }}
                                        </span>
                                          @endforeach
                                      @else
                                          <span class="text-muted">No sizes listed</span>
                                      @endif
                                  </p>
                              </div>
