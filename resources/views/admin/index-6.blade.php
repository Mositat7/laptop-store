...
{{--            <li><a href="pages/.html"><i class="mdi mdi-toggle-switch-off"></i>Weather</a></li>--}}
...
{{--        </li>--}}
		...
		<li class="treeview">
          ...
          <ul class="treeview-menu">
            <li><a href="/admin/pages/ecommerce_products"><i class="mdi mdi-toggle-switch-off"></i>Products</a></li>
