...
{{--        <input class="rounded-2xl text-zinc-700 bg-zinc-100 px-5 py-2.5 w-32 lg:w-96 placeholder:text-zinc-400 placeholder:text-xs focus:outline-0" type="text" placeholder="جستجو محصول ...">--}}
{{--        <button class="absolute top-2.5 left-3 z-50 text-white cursor-pointer">--}}
...
{{--                        </div>--}}
{{--                        <div class="flex flex-col gap-y-1">--}}
{{--                            <input type="tel" id="phone-input" placeholder="شماره تلفن" class="placeholder:text-right text-sm block w-full rounded-md border border-gray-300 px-3 py-3 font-normal text-gray-700 outline-none transition-all focus:border-primary-500 focus:outline-none">--}}
{{--                        </div>--}}
{{--                        <button id="login-btn" class="flex items-center justify-center gap-x-1 text-sm max-w-md mt-10 py-3 rounded-lg text-white bg-gradient-to-bl from-primary-600 to-primary-800 hover:opacity-85 transition w-full">--}}
{{--                            ورود--}}
{{--                        </button>--}}
...
{{--                        </div>--}}
{{--                        <div class="input-field mb-5 flex flex-row-reverse gap-x-4 justify-center">--}}
{{--                            <input name="code" type="text" maxlength="1" class="code-input border border-zinc-200 focus:border-zinc-400 w-10 h-11 rounded-md outline-none text-center focus:outline-0 focus:border focus:shadow-lg" required/>--}}
{{--                            <input name="code" type="text" maxlength="1" class="code-input border border-zinc-200 focus:border-zinc-400 w-10 h-11 rounded-md outline-none text-center focus:outline-0 focus:border focus:shadow-lg" required/>--}}
{{--                            <input name="code" type="text" maxlength="1" class="code-input border border-zinc-200 focus:border-zinc-400 w-10 h-11 rounded-md outline-none text-center focus:outline-0 focus:border focus:shadow-lg" required/>--}}
{{--                            <input name="code" type="text" maxlength="1" class="code-input border border-zinc-200 focus:border-zinc-400 w-10 h-11 rounded-md outline-none text-center focus:outline-0 focus:border focus:shadow-lg" required/>--}}
{{--                            <input name="code" type="text" maxlength="1" class="code-input border border-zinc-200 focus:border-zinc-400 w-10 h-11 rounded-md outline-none text-center focus:outline-0 focus:border focus:shadow-lg" required/>--}}
...
{{--                                        <img alt="" class="h-[120px] w-[120px] rounded-xl" src="{{ asset('assets/image/products/1.webp')}}">--}}
{{--                                    </a>--}}
{{--                                </div>--}}
{{--                                <div class="w-full space-y-1.5">--}}
{{--                                    <!-- Title -->--}}
{{--                                    <a class="line-clamp-2 h-12 text-zinc-700 font-yekanBakhRegular" href="/single-product">--}}
{{--                                        لپ تاپ مدل بنوو--}}
{{--                                    </a>--}}
{{--                                    <!-- Attribute -->--}}
...
{{--                                            <span class="text-sm">17,300,000</span>--}}
...
{{--                                <div class="relative min-w-fit">--}}
{{--                                    <a href="single-product">--}}
{{--                                        <img alt="" class="h-[120px] w-[120px] rounded-xl" src="{{ asset('assets/image/products/3.webp')}}">--}}
{{--                                    </a>--}}
{{--                                </div>--}}
{{--                                <div class="w-full space-y-1.5">--}}
{{--                                    <!-- Title -->--}}
...
{{--                        </div>--}}
{{--                    </div>--}}
{{--                    <a href="/checkout" class="w-28 py-3 text-sm bg-primary-600 hover:bg-primary-500 transition text-gray-100 rounded-xl text-center cursor-pointer">--}}
...
<script>
    // JavaScript کد قبلی که دادم رو اینجا قرار بده
    // تمام کد JavaScript که قبلا دادم رو اینجا کپی کن
</script>
