            ...
            <div class="">
                <ul class="gap-y-5 grid">
                    ...
                    @if($contactInfo && $contactInfo->address)
                        <li>
                            <a class="text-zinc-500 text-xs flex items-start gap-x-1 leading-6" href="#">
                                <svg class="fill-zinc-600 w-12" xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="" viewBox="0 0 256 256">
                    ...
                    @if($contactInfo && $contactInfo->email)
                        <li>
                            <a class="text-zinc-500 text-xs flex items-center gap-x-1" href="mailto:{{ $contactInfo->email }}">
                                <svg class="fill-zinc-600" xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="" viewBox="0 0 256 256">
                    ...
                    <!-- تلفن‌ها -->
                    @if($contactInfo && $contactInfo->phones && count($contactInfo->phones) > 0)
                        <li>
                            <div class="text-zinc-500 text-xs flex items-center gap-x-1">
                                <svg class="fill-zinc-600" xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="" viewBox="0 0 256 256">
                                ...
                                <div class="flex flex-col gap-1">
                                    @foreach($contactInfo->phones as $phone)
                                        <a href="tel:{{ $phone }}" class="text-zinc-500 hover:text-zinc-400 transition">{{ $phone }}</a>
                                    @endforeach
                                </div>
                            </div>
                        </li>
...
<!-- copyright -->
<a href="#" class="block mt-10 pt-5 text-xs leading-5 text-zinc-500 border-t border-zinc-200">
    طراحی و توسعه توسط
