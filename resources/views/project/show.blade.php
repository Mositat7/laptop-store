...
<head>
    ...
    <title>{{ $category->name }} - دیجی استار</title>
    <style>
        .desktop-sidebar {
            width: 300px;
            min-width: 300px;
            ...
            <div class="flex justify-between items-center">
                ...
                <div>
                    ...
                    <p class="text-gray-500 text-sm md:text-base">
                        مجموعه‌ای از بهترین محصولات در دسته‌بندی <span class="font-medium text-gray-700">{{ $category->name }}</span>
                    </p>
                </div>
                ...
                <div class="bg-blue-100 text-blue-700 px-6 py-3 rounded-xl flex items-center gap-2 font-semibold">
                    <svg xmlns="http://www.w3.org/2000/svg" class="w-5 h-5" fill="none" viewBox="0 0 24 24"
                         stroke="currentColor" stroke-width="2">
                        <path stroke-linecap="round" stroke-linejoin="round"
                              d="M3 3h18M3 7h18M3 21h18M3 11h18M3 15h18" />
                    </svg>
        ...
        <div class="flex gap-8">
         ...
         @include('helper/filter-products')
            ...
            <div class="desktop-content">
                ...
                <!-- گرید محصولات با فاصله بیشتر و سایز کوچک‌تر -->
