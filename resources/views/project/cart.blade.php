...
<!-- Mirrored from amirtttk.ir/digiStar/cart.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 07 Oct 2025 12:54:03 GMT -->
<head>
  <meta charset="UTF-8">
...
{{--      nav--}}
    ...
    <div class="px-2 md:px-12">
      ...
      <div class="flex flex-col lg:flex-row px-4 md:px-10 mt-10 gap-5 pb-20">
        <div class="lg:w-9/12 border border-zinc-200 rounded-xl divide-y divide-zinc-200">
          <div class="mt-7 flex flex-col md:flex-row gap-y-5 p-4">
            <div class="w-10/12 mx-auto max-w-52 md:max-w-36">
              <img class="rounded-lg" src="{{ asset('assets/image/products/1.webp')}}" alt="">
            </div>
            <div class="mr-2 md:mr-5 w-full flex flex-wrap gap-y-3">
              <div class="md:w-9/12 h-fit">
                <a href="#" class="w-full text-sm sm:text-base text-zinc-700 mb-5">
              ...
              <div class="w-full md:w-3/12 flex justify-end">
                <div class="text-gray-700">
                  ...
                  <div class="flex mt-5">
                    <div class="text-2xl md:text-3xl text-zinc-700">2,100,000</div>
          ...
          <div class="mt-7 flex flex-col md:flex-row gap-y-5 p-4">
            <div class="w-10/12 mx-auto max-w-52 md:max-w-36">
              <img class="rounded-lg" src="{{ asset('assets/image/products/5.webp')}}" alt="">
            </div>
            <div class="mr-2 md:mr-5 w-full flex flex-wrap gap-y-3">
              <div class="md:w-9/12 h-fit">
                <a href="#" class="w-full text-sm sm:text-base text-zinc-700 mb-5">
                  گوشی موبایل شیائومی مدل پوکو
                </a>
                <div class="flex gap-1.5 mt-7">
                  <div class="size-4 bg-green-800 rounded-full"></div>
        ...
        <div class="lg:w-3/12 lg:pt-5 my-10 lg:my-0">
          ...
          <a href="#" class="block bg-gradient-to-bl from-primary-400 to-primary-600 hover:opacity-80 text-white text-center mt-10 px-5 md:px-2.5 py-3 md:py-4 rounded-xl shadow-lg transition-all font-yekanBakhBold md:text-lg">
            ثبت و ادامه
          </a>
        </div>
      </div>
  ...
  <footer class="bg-white border-t border-zinc-200 w-full px-5 md:px-10 py-5">
    <!-- logo, des, go to up -->
    <div class="flex gap-x-8 gap-y-4 items-center md:items-start flex-wrap md:flex-nowrap justify-between mb-12">
      <div class="w-4/12 md:w-1/12 order-1 md:order-none">
        <img class="w-full" src="{{ asset('assets/image/logo.png') }}" alt="">
      </div>
      <div class="md:w-10/12 text-xs text-zinc-400 leading-7 order-3 md:order-none text-justify">
        دیجی استار فروشگاه آنلاین معتبری است که انواع کالاهای دیجیتال مانند گوشی، لپ‌تاپ، تبلت و لوازم جانبی را با ضمانت اصالت و ارسال سریع ارائه می‌دهد. با تنوع گسترده محصولات، قیمت‌های رقابتی و پشتیبانی حرفه‌ای، خریدی آسان و مطمئن را تجربه کنید. بررسی تخصصی، مقایسه و انتخاب آگاهانه از مزایای خرید از دیجی استار است. برای دسترسی به جدیدترین محصولات دیجیتال، همین حالا به دیجی استار سر بزنید!
      </div>
      <div class="md:w-1/12 order-2 md:order-none">
        <button type="button" class="flex items-center justify-center cursor-pointer w-28 gap-x-2 p-3 text-zinc-400 text-xs md:text-sm border border-zinc-200 rounded-lg" id="btn-back-to-top" style="display: flex;">
          برو به بالا
    ...
    <!-- 5 good box -->
    <div class="my-12 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 xl:grid-cols-5 gap-5">
    ...
    <div class="flex flex-col md:flex-row gap-y-8">
      <div class="md:w-5/12 grid grid-cols-2 md:grid-cols-3">
        ...
        <div>
          ...
          <div class="">
            <ul class="gap-y-5 grid grid-rows-4 row">
              <a href="#">
                <li class="text-zinc-400 hover:text-primary-500 transition-all text-xs hover:pr-1 ease-out duration-300">
                  شیائومی
                </li>
        ...
        <div>
          ...
          <div class="">
            <ul class="gap-y-5 grid">
              <li>
                <a class="text-zinc-500 text-xs flex items-start gap-x-1 leading-6" href="#">
                  ...
                  تهران-خیابان دماوند-روبرو خیابان دماوند-شرکت دیجی استار
                </a>
              </li>
              <li>
                <a class="text-zinc-500 text-xs flex items-center gap-x-1" href="#">
      ...
      <div class="md:w-4/12 flex justify-center gap-x-7">
        <img class="h-fit max-w-20 md:max-w-28" src="{{ asset('assets/image/service/symbol-02.png') }}" alt="">
        <img class="h-fit max-w-20 md:max-w-28" src="{{ asset('assets/image/service/zarinPal.png') }}" alt="">
      </div>
      <div class="md:w-4/12">
    ...
    <!-- copyright -->
    <a href="https://www.rtl-theme.com/author/amirtttk/products/" class="block mt-10 pt-5 text-xs leading-5 text-zinc-500 border-t border-zinc-200">
      طراحی و توسعه توسط
      <span class="text-xs md:text-sm text-primary-500 font-yekanBakhBold">
        امیررضا کریمی
      </span>
        .
    </a>
